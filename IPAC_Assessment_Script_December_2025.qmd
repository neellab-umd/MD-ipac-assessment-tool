...
if (params$genus_only) {
  ...
  cat(paste0("**INITIATION:** The *", species_name, "* species were listed in Maryland as Tier 2 invasive plants in ", tier_2_year, ". They are being re-evaluated in accordance with Maryland Code, Agriculture Title 9.5 (§§ 9.5-101–9.5-306).\n\n"))
} 
```
...
if (params$genus_only) {
  ...
  cat("**FAMILY:** ", family, "\n\n", sep = "")
  cat(paste0("**INITIATION:** *", species_name, "* was listed in Maryland as a Tier 2 invasive plant in ", tier_2_year, ". The species is being re-evaluated in accordance with Maryland Code, Agriculture Title 9.5 (§§ 9.5-101–9.5-306).\n\n"))
